...
public class MainFrame extends JFrame {
    ...
    private final JTextField programNameField = createFilledField(UserSettings.get("programName", "Merged App"));
    private final JTextField displayNameField = createFilledField(UserSettings.get("displayName", "Merged App"));
    ...
    private final JTextField savePathField = createFilledField(UserSettings.get("savePath", "Embedded.jar"));
    ...
    private void setupKeyboardShortcuts() {
        ...
        selectJarAction = new AbstractAction("selectJar") {
            @Override public void actionPerformed(ActionEvent e) { selectJar(); }
        };
        mergeAction = new AbstractAction("merge") {
            @Override public void actionPerformed(ActionEvent e) { startMerge(); }
        };
        openOutputAction = new AbstractAction("openOutput") {
            @Override public void actionPerformed(ActionEvent e) { openOutputFolder(); }
        };
        ...
        im.put(KeyStroke.getKeyStroke(KeyEvent.VK_O, InputEvent.CTRL_DOWN_MASK | InputEvent.SHIFT_DOWN_MASK), "openOutput");
    ...
    private JPanel createJarPanel() {
        ...
        panel.setBorder(new EmptyBorder(Theme.SPACING_MD, Theme.SPACING_MD, Theme.SPACING_MD, Theme.SPACING_MD));

        // ── Top: toolbar ──
        JPanel toolbar = new JPanel(new FlowLayout(FlowLayout.LEFT, Theme.SPACING_SM, Theme.SPACING_SM));
        toolbar.setBackground(Theme.SURFACE);
        toolbar.setBorder(new EmptyBorder(Theme.SPACING_XS, Theme.SPACING_SM, Theme.SPACING_XS, Theme.SPACING_SM));
        ...
        JLabel emptyLabel = UIHelpers.helperText("No JAR file selected. Click \"Select JAR\" to begin.");
        ...
        countPanel.setBorder(new EmptyBorder(Theme.SPACING_MD, Theme.SPACING_LG, Theme.SPACING_MD, Theme.SPACING_LG));
    ...
    private JPanel createSettingsPanel() {
        ...
        outer.setBorder(new EmptyBorder(Theme.SPACING_XL, Theme.SPACING_XL, Theme.SPACING_XL, Theme.SPACING_XL));
    ...
    private JPanel createMergePanel() {
        ...
        panel.setBackground(Theme.BACKGROUND);
        panel.setBorder(new EmptyBorder(Theme.SPACING_XL, Theme.SPACING_XL, Theme.SPACING_XL, Theme.SPACING_XL));
    ...
    private void startMerge() {
        ...
        UserSettings.save(
            merger.programName, merger.displayName, merger.vendorName,
            merger.iconPath, merger.savePath, String.valueOf(copies)
        );
